...
ENV NEXT_PUBLIC_CODEX_ROOT=${NEXT_PUBLIC_CODEX_ROOT}
ENV NEXT_PUBLIC_GEMINI_ROOT=${NEXT_PUBLIC_GEMINI_ROOT}
ENV CLAUDE_ROOT=${NEXT_PUBLIC_CLAUDE_ROOT}
ENV CODEX_ROOT=${NEXT_PUBLIC_CODEX_ROOT}
ENV GEMINI_ROOT=${NEXT_PUBLIC_GEMINI_ROOT}
